      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-px -ml-20 min-w-max">
          <div className="text-white flex flex-col sm:flex-row items-start sm:items-center">
            <FadeIn delay={0.1}>
              <p className="text-18 sm:text-20 font-medium mr-2">
                Damian Smyth{" "}
              </p>
            </FadeIn>
            <FadeIn delay={0.2}>
              <p className="opacity-80 text-16 sm:text-20 font-light leading-none">
                - Global CCO.
              </p>
            </FadeIn>
          </div>
          <div className="text-white flex flex-col sm:flex-row items-start sm:items-center">
            <FadeIn delay={0.3}>
              <p className="text-18 sm:text-20 font-medium mr-2">Alex Manby </p>
            </FadeIn>
            <FadeIn delay={0.5}>
              <p className="opacity-80 text-16 sm:text-20 font-light leading-none">
                - Global CSO.
